...
import fr.uiytt.magiclauncher.update.PackInfos;
import fr.uiytt.magiclauncher.update.PausableSwingWorker;
...
public class LauncherFrame {
	...
	public void createInterface() throws IOException {
		...
		try {
			InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/Menu.png");
		...
		try {
			InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/unicorn.png");
			BufferedImage img = ImageIO.read(res);
		...
		InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/launchbutton1.png");
		BufferedImage img = ImageIO.read(res);
		...
		this.launchbutton.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent evt) {
				if (LauncherFrame.this.launchbutton.isEnabled()) {
					InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/launchbutton2.png");
		...
		this.configbutton.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent evt) {
				if (LauncherFrame.this.configbutton.isEnabled()) {
					InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/configbutton2.png");
		...
		res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/pausebutton1.png");
		...
		this.pausebutton.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/pausebutton2.png");
			...
			public void mouseExited(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/pausebutton1.png");
		...
		res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/playbutton1.png");
		img = ImageIO.read(res);
		...
		this.resumbutton.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/playbutton2.png");
			...
			public void mouseExited(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/playbutton1.png");
		...
		res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/closebutton1.png");
		img = ImageIO.read(res);
		...
		this.stopbutton.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/closebutton2.png");
			...
			public void mouseExited(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/closebutton1.png");
		...
		res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/progressbar.png");
		img = ImageIO.read(res);
		...
		res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/websitebutton.png");
		img = ImageIO.read(res);
		...
		this.websitebutton.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/websitebutton2.png");
			...
			public void mouseExited(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/websitebutton.png");
	...
	public void initconfig() {
		try {
			InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/configmenu.png");
			BufferedImage img = ImageIO.read(res);
		...
		this.filechooser.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/filechooserbutton.png");
		...
		this.repairbutton.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent evt) {
				InputStream res = Main.class.getResourceAsStream("/fr/uiytt/magiclauncher/img/repairbutton.png");
